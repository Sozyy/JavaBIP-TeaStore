...
java -cp target/JavaBIP-TeaStore-1.0-SNAPSHOT-jar-with-dependencies.jar adapteastore.Main


*/
import adapteastore.cache.SwitchableCache;
            ...
            while (true) {
                ...
                if (delta > 0) {
                    ...
                    if (newCacheSize >= 0) {
                        ...
                        System.out.printf("[Monitor] iter=%4d  delta=%4d  -> PID_cache=%d  strategy=%s  -> image=%s%n",
